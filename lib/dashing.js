...
module.exports.Dashing = function Dashing() {
  ...
  dashing.authenticateUser = function (user, pass, callbackResult) {
    var username = dashing.username ? dashing.username : 'admin';
    var password = dashing.password ? dashing.password : 'admin';
